...
class TmapAddressConfigFlow(config_entries.ConfigFlow, domain="tmap_address"):
    VERSION = 1
    ...
    def async_get_options_flow(config_entry):
        return TmapAddressOptionsFlow(config_entry)

class TmapAddressOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        ...
        return self.async_show_form(
            step_id="init",
            data_schema=vol.Schema({
                vol.Required("target_entity", default=self.config_entry.data.get("target_entity")): str,
